# Luau
Lua modules, plugins, experiences, exploits.
Most designated for Roblox engine (Luau), however minor revisions can be made in some to support Lua.
...
## /Exploits
Tens of thousands of lines of dedication from extensive reverse-engineering of experiences. **Educational purposes only; all discoveries were later reported to experiences' respective developers.**
