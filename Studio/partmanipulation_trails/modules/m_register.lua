...
function module.register(part, data)
	assert(part:IsA"BasePart" and not (part.Anchored or part:IsGrounded()), "Registers must be BaseParts that are neither anchored nor grounded.") --your job to check network ownership
