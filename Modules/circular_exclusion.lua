...
function module.getRandomQuadPosExcludingCircleXZ(min: Vector3, squarelen: number, radius: number): Vector3
...
local getRandomQuadPosExcludingCircleXZ = module.getRandomQuadPosExcludingCircleXZ
